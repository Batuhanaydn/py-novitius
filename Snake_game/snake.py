...
def start(x,y):
    ...
    while x > -210 and x < 210 and y > -210 and y < 210:
        ...
        if x > fcoord[0]*20-5 and x < fcoord[0]*20+5 and y > fcoord[1]*20-5 and y < fcoord[1]*20+5:
            ...
            a[0] += 1
            tscore.clear()
            tscore.write("\nScore:" + str(a[0]) + "\nCreator: Batuhan Aydın", align="center",font=(10))
...
def gameover():
    ...
    turtle.goto(0,150)
    turtle.color("red")
    turtle.write("Game Over", align="center", font=(20))
    turtle.goto(0,50)
    turtle.write("Score:" + str(a[0]), align="center",font=(10))
    turtle.goto(200,-200)
    turtle.write("(Click anywhere to return to the main menu) ",align="right",font=(0.000001))
